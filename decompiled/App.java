...
public class App {
    ...
    public void run() {
        while (true) {
            String presidentsList = this.displayPresidentsInTwoColumns();
            String wrong = this.displayWrongGuesses();
            String message = presidentsList + "\n\n" + wrong;
            JOptionPane.showMessageDialog(null, message);
            String answer = JOptionPane.showInputDialog("Name a president (Type exit to quit):");
            if (answer == null || answer.toLowerCase().contains("exit") || answer.toLowerCase().contains("quit")) break;
    ...
    private String displayPresidentsInTwoColumns() {
        ...
        i = 0;
        while (i < halfWay) {
            sb.append(String.format("%-" + yearWidth + "s %-" + nameWidth + "s%-" + yearWidth + "s %-" + nameWidth + "s%n", displayGrid[i][0], displayGrid[i][1], displayGrid[i][2], displayGrid[i][3]));
            ++i;
        }
        return sb.toString();
    }
    ...
    private String displayWrongGuesses() {
        ...
        while (i < this.wrongGuesses.size()) {
            sb.append(this.wrongGuesses.get(i));
